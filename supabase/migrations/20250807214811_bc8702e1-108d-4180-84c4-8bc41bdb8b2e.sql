-- Actualizar la función de transición automática para verificar solo documentos reales y plan de pagos por separado
...
BEGIN
  ...
  IF EXISTS (
    ...
    AND EXISTS (
      -- Verificar solo documentos reales (CSF y contrato)
