...
CREATE INDEX idx_cronograma_matriz_manual_cliente_proyecto ON public.cronograma_matriz_manual(cliente_id, proyecto_id);
CREATE INDEX idx_cronograma_matriz_manual_mes ON public.cronograma_matriz_manual(mes);
CREATE INDEX idx_cronograma_matriz_manual_concepto ON public.cronograma_matriz_manual(concepto);

-- Create unique constraint to prevent duplicate entries
CREATE UNIQUE INDEX idx_cronograma_matriz_manual_unique ON public.cronograma_matriz_manual(cliente_id, proyecto_id, mes, concepto);
