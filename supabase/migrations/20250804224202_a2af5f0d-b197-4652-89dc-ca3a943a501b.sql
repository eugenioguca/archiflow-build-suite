...
ALTER TABLE public.partidas_catalog ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Employees and admins can manage partidas catalog" 
ON public.partidas_catalog 
FOR ALL 
TO authenticated 
USING (
  EXISTS (
...
-- Insert some default partidas
INSERT INTO public.partidas_catalog (code, name, category, unit, created_by) VALUES
('P001', 'Cemento', 'Materiales', 'Bulto', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P002', 'Arena', 'Materiales', 'M3', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P003', 'Grava', 'Materiales', 'M3', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P004', 'Varilla', 'Materiales', 'Kg', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P005', 'Block', 'Materiales', 'Pieza', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P006', 'Tabique', 'Materiales', 'Pieza', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P007', 'Pintura', 'Materiales', 'Litro', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P008', 'Albanilería', 'Mano de Obra', 'M2', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P009', 'Plomería', 'Instalaciones', 'Salida', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
('P010', 'Electricidad', 'Instalaciones', 'Salida', (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1));