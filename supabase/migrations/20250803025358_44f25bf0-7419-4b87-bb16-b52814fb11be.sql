-- =====================================================
-- FASE 3: DATOS DE PRUEBA PARA MÓDULO DE FINANZAS (CORREGIDO)
-- =====================================================
...
BEGIN
    ...
    VALUES 
      (gen_random_uuid(), 'Caja General', 'general', 850000.00, 1000000.00, 'active', admin_profile_id, 'Cuenta principal de efectivo', null),
      (gen_random_uuid(), 'Fondo Proyecto Los Pinos', 'project_fund', 450000.00, 500000.00, 'active', admin_profile_id, 'Fondo específico para proyecto Los Pinos', proyecto_pinos_id),
      (gen_random_uuid(), 'Caja Chica Oficina', 'petty_cash', 25000.00, 50000.00, 'active', admin_profile_id, 'Gastos menores de oficina', null)
    ON CONFLICT (id) DO NOTHING;
