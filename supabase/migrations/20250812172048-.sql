-- Corregir la función delete_project_cascade eliminando referencias a tablas inexistentes
...
BEGIN
  ...
  -- Delete unified financial transactions for this project
  DELETE FROM public.unified_financial_transactions WHERE project_id = project_id_param;
