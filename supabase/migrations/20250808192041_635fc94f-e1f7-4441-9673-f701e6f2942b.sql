-- Arreglar función get_users_by_department para trabajar con enums
...
-- Arreglar función get_users_by_position para trabajar con enums
...
-- Mejorar función get_project_team_members para incluir todos los roles del proyecto
