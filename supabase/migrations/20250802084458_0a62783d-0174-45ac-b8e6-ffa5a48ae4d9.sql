-- Fix the revert_project_from_construction function to use correct column name
...
BEGIN
  ...
  -- Log the reversion action (fixed to use total_budget instead of construction_budget)
