-- Fase 1: Corrección de Datos de Prueba (CRÍTICO)
...
INSERT INTO public.client_projects (
  ...
  budget, construction_budget, service_type, created_by
) VALUES 
...
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333331', 
 ...
 'design', 'propuesta_enviada', 1200000, 960000, 'residencial', 
 (SELECT id FROM public.profiles WHERE role = 'admin' LIMIT 1)),
...
-- Corregir funciones de seguridad (Fase 3: Security)
-- Actualizar funciones existentes para agregar SET search_path

-- Función update_cash_account_balance
