-- First check and drop existing triggers related to auto transition
DROP TRIGGER IF EXISTS trigger_auto_transition_to_design ON client_projects CASCADE;
DROP FUNCTION IF EXISTS auto_transition_to_design() CASCADE;

-- Create the updated auto_transition_to_design function
