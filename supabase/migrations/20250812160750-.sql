-- Step 1: Add sender information columns to project_chat table
ALTER TABLE public.project_chat 
ADD COLUMN sender_name TEXT,
ADD COLUMN sender_avatar TEXT;

-- Step 2: Update chat_notifications to ensure consistency
-- (The table already uses recipient_id, which is good)
