-- Corregir la función delete_project_cascade usando los nombres correctos de columnas
...
BEGIN
  ...
  -- Only delete from tables that actually exist with correct column names
  ...
  -- Delete unified financial transactions for this project (using correct column name)
  DELETE FROM public.unified_financial_transactions WHERE empresa_proyecto_id = project_id_param;
  
  -- Delete treasury transactions for this project
  DELETE FROM public.treasury_transactions WHERE project_id = project_id_param;
  
  -- Delete billing clients for this project
  DELETE FROM public.billing_clients WHERE project_id = project_id_param;
  
  -- Delete CFDI documents for this project (by expense)
